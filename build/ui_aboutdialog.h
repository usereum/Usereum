...
"Copyright &copy; 2011-YYYY The Usereum developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Usereum", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Usereum</b> version", 0));
